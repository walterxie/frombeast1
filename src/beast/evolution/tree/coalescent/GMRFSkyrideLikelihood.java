...
//	protected double[] gmrfWeights;
	...
	protected CompoundParameterHelper dMatrix;
...
//    }
    ...
    public void initAndValidate() {
        ...
        setTree(Collections.singletonList(tree));
...
//    }
	public static void checkTree(Tree treeModel) {
        ...
        for (final Node node : treeModel.getInternalNodes()) {
...
//			betaParameter.somethingIsDirty();
	...
	protected double calculateLogCoalescentLikelihood() {
        ...
        double[] currentGamma = popSizeParameter.getDoubleValues();
    ...
    protected double calculateLogFieldLikelihood() {
        ...
        DenseVector currentGamma = new DenseVector(popSizeParameter.getDoubleValues());
